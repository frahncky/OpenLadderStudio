...
$replacements = @(
    ...
    @('Color.FromArgb(244, 247, 250)', 'Color.FromArgb(250, 252, 255)'),
...
# Toolbar: nomes e agrupamento proximos do mockup, preservando as acoes existentes.
...
$replacement = @'
        private static Color ToolColor(StudioIcon icon)
        {
            switch (icon)
            {
                ...
                case StudioIcon.Redo: return Color.FromArgb(93, 110, 130);
