...
"%CSC%" /nologo /target:winexe /optimize+ /win32icon:"OpenLadderStudio.ico" /win32manifest:"OpenLadderStudio.manifest" /main:ModernPC12.TP02PgLinkV37Program /out:"OpenLadderTP02PgLink.exe" /reference:System.dll /reference:System.Windows.Forms.dll /reference:System.Drawing.dll "AppBranding.cs" "StudioDiagnostics.cs" "DockOrder.cs" "PLCPlatform.build.cs" "PLCCustomProfiles.cs" "PLCConnectionSettings.cs" "TP02PgFrameParserV33.cs" "TP02PgLinkV37.cs"
if errorlevel 1 goto :erro

del /q "PLCPlatform.build.cs" >nul 2>&1
echo.
echo OpenLadderTP02PgLink.exe v0.37 criado com sucesso.
echo Execute INICIAR_LINK_PG_V037.bat para testar no TP02.
exit /b 0

:erro
del /q "PLCPlatform.build.cs" >nul 2>&1
echo.
echo Falha ao compilar o Link PG v0.37.
pause
exit /b 1
