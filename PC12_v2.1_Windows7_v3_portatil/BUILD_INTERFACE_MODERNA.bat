...
if errorlevel 1 goto :erro
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0PrepareUniversalStudioV17.ps1"
if errorlevel 1 goto :erro
...
"%CSC%" /nologo /target:winexe /optimize+ /main:ModernPC12.ModbusMonitorProgramV17 /out:"OpenLadderModbus.exe" /reference:System.dll /reference:System.Windows.Forms.dll /reference:System.Drawing.dll "PLCPlatform.build.cs" "PLCCustomProfiles.cs" "PLCConnectionSettings.cs" "PLCMemoryMapV15.cs" "PLCMemoryMapManagerV15.build.cs" "ModbusCore.cs" "ModbusBulkReader.cs" "ModbusMonitorV17.build.cs"
if errorlevel 1 goto :erro
