...
echo [1/7] Compilando central PC12 Modern...
...
echo [2/7] Compilando PC12 Ladder Studio...
...
echo [3/7] Compilando TP02 Bridge Lab...
...
echo [4/7] Compilando leitor RBP...
...
echo [5/7] Compilando decodificador RBP para IL...
...
echo [6/7] Compilando calibracao automatica de opcodes...
...
echo [7/7] Compilando PC12 Studio unificado...
"%CSC%" /nologo /target:winexe /optimize+ /main:ModernPC12.UnifiedProgram /out:"PC12_Studio.exe" /reference:System.dll /reference:System.Windows.Forms.dll /reference:System.Drawing.dll "PC12Studio.cs" "ModernPC12.cs" "LadderEditor.build.cs" "TP02BridgeLab.cs" "TP02ProgramReader.cs" "TP02MachineDecoder.cs" "TP02OpcodeCalibration.cs"
if errorlevel 1 goto :erro
