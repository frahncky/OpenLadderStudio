...
$fieldReplacement = "        private TP02BridgeForm bridgeForm;`r`n        private TP02PgLinkV33Form tp02ControlForm;"
...
$section = $section.Replace($oldCreate, 'if (tp02ControlForm == null || tp02ControlForm.IsDisposed) tp02ControlForm = new TP02PgLinkV33Form();')
$section = $section.Replace($oldShowPrefix, 'ShowDocument(tp02ControlForm,')
$section = $section.Replace($oldStatus, 'statusText.Text = "TP02: Link PG com enquadramento binario";')
