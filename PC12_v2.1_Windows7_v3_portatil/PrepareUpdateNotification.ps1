...
& (Join-Path $root 'PrepareUiV52.ps1')
& (Join-Path $root 'PrepareUiV53.ps1')
& (Join-Path $root 'PrepareUiV54.ps1')
& (Join-Path $root 'PrepareUiV55.ps1')
& (Join-Path $root 'PrepareUiV56.ps1')
...
& (Join-Path $root 'PrepareUpdateExperienceV62.ps1')
& (Join-Path $root 'PrepareFunctionalAuditV66.ps1')
& (Join-Path $root 'PrepareFunctionalMenuV67.ps1')
& (Join-Path $root 'PrepareVisualStudioLightV68.ps1')
& (Join-Path $root 'PrepareStartupStabilityV70.ps1')
& (Join-Path $root 'PrepareWorkspaceLayoutV72.ps1')
& (Join-Path $root 'PrepareWorkspacePolishV73.ps1')
& (Join-Path $root 'PrepareLadderZoomV74b.ps1')
...
& (Join-Path $root 'PrepareLadderSymbolsV80.ps1')
& (Join-Path $root 'PrepareLadderInteractionV81.ps1')
& (Join-Path $root 'PrepareStartupProfileV82.ps1')
