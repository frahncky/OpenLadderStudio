...
# Aplicamos o tema claro depois dela para que seja a ultima camada de UI.
$v68 = Join-Path (Get-Location) 'PrepareVisualStudioLightV68.ps1'
if (-not (Test-Path $v68)) { throw 'PrepareVisualStudioLightV68.ps1 nao encontrado.' }
& $v68
