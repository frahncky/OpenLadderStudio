...
# LadderCanvas: zoom 50%-200% com a mesma geometria para desenho e mouse.
...
# Shell: indicador, comandos e atalhos.
...
$shell = [Regex]::Replace($shell, '(?m)^\s*modeText\.Text = .*MODO: EDIÇÃO.*;$', '                V74UpdateModeText();')
...
# Insere as opcoes de zoom imediatamente antes do menu Projeto, sem depender da
# formatacao interna do bloco Exibir.
$projectMenuAnchor = '            ToolStripMenuItem projeto = MenuItem("Projeto");'
$zoomMenu = @'
