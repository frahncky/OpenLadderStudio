...
$guidePath = Join-Path $repoRoot 'docs\development-guide.md'
...
if (-not (Test-Path -LiteralPath (Join-Path $repoRoot $catalog.sourceRoot) -PathType Container)) {
    throw "Source directory missing: $($catalog.sourceRoot)"
}
