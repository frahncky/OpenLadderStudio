    ...
    internal static class Tp02PgProtocol
    {
        ...
        internal static IList<CommandInfo> GetCommandCatalog()
        {
            return new List<CommandInfo>
            {
                ...
                new CommandInfo("03", "03 00 FC", "Preparação/limpeza antes de gravar programa", "5 chamadas: ação confirmada em STOP e preflight do PG33", false),
                new CommandInfo("04", "04 00 FB", "Operação de modo/serviço A", "Handler próprio; exige PLC em STOP", false),
                ...
                new CommandInfo("11", "11 00 EE", "Operação de modo/serviço B", "Handler próprio; exige PLC em STOP", false),
