...
if not exist "PreparePgLab38VariantsV25.ps1" (
    echo PreparePgLab38VariantsV25.ps1 nao encontrado.
    exit /b 1
)
if not exist "PreparePgLab38StructuralV26.ps1" (
    echo PreparePgLab38StructuralV26.ps1 nao encontrado.
    exit /b 1
)
if not exist "PreparePgLabDecode34V27.ps1" (
...
if not exist "PreparePgLabPaginationV29.ps1" (
    echo PreparePgLabPaginationV29.ps1 nao encontrado.
    exit /b 1
)
if not exist "PreparePgLabPaginationV30.ps1" (
    echo PreparePgLabPaginationV30.ps1 nao encontrado.
    exit /b 1
)
...
if not exist "..\OpenLadderStudio.Core\Tp02Pg34Pager.cs" (
    echo Tp02Pg34Pager.cs nao encontrado.
    exit /b 1
)
if not exist "TP02PhysicalValidator.cs" (
    echo TP02PhysicalValidator.cs nao encontrado.
    exit /b 1
)
if not exist "..\..\tests\OpenLadderStudio.Core.Tests\TP02PhysicalValidatorSafetySelfTest.cs" (
    echo TP02PhysicalValidatorSafetySelfTest.cs nao encontrado.
    exit /b 1
)
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0PreparePgLab38VariantsV25.ps1"
if errorlevel 1 goto :erro

powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0PreparePgLab38StructuralV26.ps1"
if errorlevel 1 goto :erro
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0PreparePgLabPaginationV29.ps1"
if errorlevel 1 goto :erro
...
"%CSC%" /nologo /target:winexe /optimize+ /win32icon:"OpenLadderStudio.ico" /win32manifest:"OpenLadderStudio.manifest" /main:ModernPC12.TP02PhysicalValidatorProgram /out:"OpenLadderTP02PhysicalValidator.exe" /reference:System.dll /reference:System.Windows.Forms.dll /reference:System.Drawing.dll "AppBranding.cs" "StudioDiagnostics.cs" "..\OpenLadderStudio.Core\Tp02PgProtocol.cs" "..\OpenLadderStudio.Core\Tp02PgMemoryProtocol.cs" "..\OpenLadderStudio.Core\Tp02Pg34Pager.cs" "TP02PhysicalValidator.cs"
if errorlevel 1 goto :erro

"%CSC%" /nologo /target:exe /optimize+ /win32manifest:"OpenLadderStudio.manifest" /main:TP02PhysicalValidatorSafetySelfTest /out:"OpenLadderTP02PhysicalValidatorSafetyTest.exe" /reference:System.dll /reference:System.Windows.Forms.dll /reference:System.Drawing.dll "AppBranding.cs" "StudioDiagnostics.cs" "..\OpenLadderStudio.Core\Tp02PgProtocol.cs" "..\OpenLadderStudio.Core\Tp02PgMemoryProtocol.cs" "..\OpenLadderStudio.Core\Tp02Pg34Pager.cs" "TP02PhysicalValidator.cs" "..\..\tests\OpenLadderStudio.Core.Tests\TP02PhysicalValidatorSafetySelfTest.cs"
if errorlevel 1 goto :erro

".\OpenLadderTP02PhysicalValidatorSafetyTest.exe"
if errorlevel 1 goto :erro

del /q "TP02PgLab.build.cs" >nul 2>&1
echo OpenLadderTP02PgLab.exe e OpenLadderTP02PhysicalValidator.exe criados com sucesso.
echo Validador fisico: allowlist READ-ONLY CON-ICB/F0/38/34/0A; 09/33/35/Clear/RUN/STOP/EEPROM bloqueados.
exit /b 0
