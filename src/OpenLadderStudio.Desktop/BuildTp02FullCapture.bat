...
rem restauramos a versao imutavel do commit antes de aplicar os patches v1.59/v1.60/v1.61.
where git >nul 2>&1
if not errorlevel 1 (
  echo ===== V161 DIAG: git show AcquirePort =====
...
echo OpenLadderTP02FullCapture.exe v1.61 criado e autoteste offline aprovado.
exit /b 0
