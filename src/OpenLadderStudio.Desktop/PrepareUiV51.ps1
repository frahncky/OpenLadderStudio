...
$nav = @'
        private Panel BuildNav()
        {
            ...
            items.Add(ToolItem("Ramo paralelo NA", StudioIcon.BranchNO, LadderTool.ParallelNO));
            items.Add(ToolItem("Ramo paralelo NF", StudioIcon.BranchNC, LadderTool.ParallelNC));
            ...
            items.Add(ToolItem("SET", StudioIcon.CoilSet, LadderTool.Set));
            items.Add(ToolItem("RESET", StudioIcon.CoilReset, LadderTool.Reset));
            items.Add(ToolItem("Borda de subida", StudioIcon.EdgeUp, LadderTool.EdgeUp));
            items.Add(ToolItem("Borda de descida", StudioIcon.EdgeDown, LadderTool.EdgeDown));
